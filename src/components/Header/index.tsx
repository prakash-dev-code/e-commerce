  ...
  const signInoptions = [
    {
      label: "Sign In",
      value: "/signin",
      icon: <FiLogIn size={18} color="blue" />,
    },
    {
      label: "Sign Up",
      value: "/signup",
      icon: <LuUserPlus size={18} color="blue" />,
    },
    {
      label: "My Profile",
      value: "/my-account",
      icon: <CgProfile size={18} color="blue" />,
    },
    // {
    //   label: "Orders",
    //   value: "/orders",
    //   icon: <HiShoppingBag size={18} color="blue" />,
    // },
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              <div className="w-full ">
                <h2 className="text-2xl font-bold text-dark">ECommerce</h2>
                {/* <Image
